...
it("section headers", () => {
	...
	.should.equal('<h2 id="01.1"><a href="#01.1" class="header-anchor">01.1</a>Lorem ipsum</h2><div class="targets-fixing"><div class="targets-wrapper"><a id="tag-target" href="#tag-target" class="target">tag&#8209;target</a></div></div>');
...
it("sub-section headers", () => {
	...
	.should.equal('<h3 id="lorem-ipsum"><a href="#lorem-ipsum" class="header-anchor">#</a>Lorem ipsum</h3><div class="targets-fixing"><div class="targets-wrapper"><a id="tag-target" href="#tag-target" class="target">tag&#8209;target</a></div></div>');
